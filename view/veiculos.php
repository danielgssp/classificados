...
<head>
    ...
    <title>Classificados - Veículos</title>
        ...
        <div class="row">
                <div class="col-md-8">
                    <?php 
                        ...
                        <div class="hline"></div> 
                    <?php } 
                    if (empty($textoAnuncio) || empty($CATEGORIA)) {
           ...
           <div class="spacing"></div>
            ...
            <div class="hline"></div>
            <p id="subCategoria" class="p_sub_cat"><a href="veiculos.php?<?php echo($dadosSubCat["id_secao"]);?>">
