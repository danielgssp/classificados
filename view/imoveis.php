...
<?php 
    ...
    include("../dao/consultaImoveis.php");
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<head>
    ...
    <title>Classificados - Imóveis</title>
    ...
    <div class="container mtb">
        <div class="row">
           ...
           <div class="spacing"></div>
            ...
            <div class="hline"></div>
            <p id="subCategoria" class="p_sub_cat"><a href="imoveis.php?id=<?php echo($dadosSubCat["id_secao"]);?>&sub=<?php echo($dadosSubCat["descricao"]);?>">
