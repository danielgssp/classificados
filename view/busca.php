...
<head>
    ...
    <title>Classificados - Buscar Anuncio</title>
...
<body>
    ...
    <div class="container mtb">
        <div class="row">
                <div class="col-md-8">
                    <?php 
                        while($dadosBusca = $excQueryBusca-> fetch_array()){?>
                        <h3 class="ctitle">
                            <?php echo $dadosBusca["titulo"];?>
                        </h3>
                        <p>
                            <csmall>Post: 
                            <?php
                                $dataFormatada = new DateTime($dadosBusca['datapub']);
                        ...
                        <p>
                            <?php
                                $txtDadosBusca = $dadosBusca["texto"];
                                echo $txtDadosBusca;
                            ?>
                        </p>
                        <div class="hline"></div> 
                    <?php } 
                    if (empty($txtDadosBusca)) {
                        echo $msgBuscaVazia;
                    }
                    ?>
                </div>
