...
// !------------------------- consulta p/ menu subcategoria -------------------------!
	...
	$consultaSubCategoria = "SELECT subcategorias.descricao, subcategorias.id_secao FROM subcategorias, categorias WHERE categorias.secao = 'veiculos' AND subcategorias.id_subcategoria = 2";
